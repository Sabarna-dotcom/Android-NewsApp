...
public class Adaptar extends RecyclerView.Adapter<Adaptar.ViewHolder> {
    ...
    public Adaptar(Context context, ArrayList<ModelClass> modelClassArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adaptar.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
